...
class ArrayBufferCursor {
     ...
     */
    constructor(buffer_or_capacity, little_endian) {
     ...
     */
    string_ascii(max_byte_length, null_terminated, drop_remaining) {
     ...
     * Consumes up to max_byte_length bytes.
     */
    string_utf_16(max_byte_length, null_terminated, drop_remaining) {
        const string_length = null_terminated
    ...
    write_string_ascii(str, byte_length) {
        let i = 0;
    ...
    _index_of_u8(value, max_byte_length) {
    ...
    _index_of_u16(value, max_byte_length) {
        const max_pos = Math.min(this.position + max_byte_length, this.size);
